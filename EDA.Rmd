...
# Kruskal Test regarding user ID and rating
...
- The plot shows that the raing is not normally distributed, we need to use non parametric test.
- Thus, we used the Kruskal Test regarding user ID and rating.
